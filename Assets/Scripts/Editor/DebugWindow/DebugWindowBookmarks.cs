...
public partial class DebugWindow
{
    ...
    {
        var guids = new List<string>(EditorPrefs.HasKey(BOOKMARKS_GUID_KEY) ?
            JsonReader.Deserialize<string[]>(EditorPrefs.GetString(BOOKMARKS_GUID_KEY)) : new string[0]);
    ...
    private void OnGUIBookmarks()
    {
        ...
        if (EditorGUI.EndChangeCheck())
        {
            ...
            EditorPrefs.SetString(BOOKMARKS_GUID_KEY, JsonWriter.Serialize(guids));
        }
